              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Reported by {report.reporter?.username || 'Unknown'} on {new Date(report.created_at).toLocaleDateString()}
                  </p>
                  {report.description && (
                  ...
                  <div className="text-sm">
                    {report.reported_game && (
                      <p>
                        <strong>Game:</strong> {report.reported_game.title} by {report.reported_game.developer}
                        <Link href={`/games/${report.reported_game_id}`} className="ml-2 text-primary-600 hover:underline">
                          View Game
                        </Link>
                      </p>
                    )}
                    {report.reported_user && (
                      <p>
                        <strong>User:</strong> {report.reported_user.username} ({report.reported_user.email})
                      </p>
                    )}
                  </div>
                </div>
